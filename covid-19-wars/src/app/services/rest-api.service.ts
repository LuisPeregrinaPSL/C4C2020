...
export class RestApiService {
  ...
  get(url: string) {
    return this.http.get(Constants.CLOUDANT_SERVER + '/' + url);
  }
  ...
  post(url: string, body: any) {
    return this.http.post(Constants.CLOUDANT_SERVER + url, body);
  }

  put(url: string, body: any) {
    return this.http.put(Constants.CLOUDANT_SERVER + url, body);
  }
